 ...
 * helper methods.
 */
public class BuzzerIntentService extends IntentService {
    ...
    public BuzzerIntentService() {
        super("BuzzerIntentService");
    }
    ...
    public static void startActionFoo(Context context, String param1, String param2) {
        Intent intent = new Intent(context, BuzzerIntentService.class);
